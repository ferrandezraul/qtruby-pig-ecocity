...
class ProductsTab < Qt::Widget
  ...
  def initialize( products, parent = nil )
    ...
    products.each_with_index do | product, row |
      ...
      products_model.setData( products_model.index( row, 1, Qt::ModelIndex.new), qVariantFromValue( Qt::AlignRight ), Qt::TextAlignmentRole )

      products_model.setData( products_model.index( row, 2, Qt::ModelIndex.new), Qt::Variant.new( "#{product.price_coope} EUR" ) )
      products_model.setData( products_model.index( row, 2, Qt::ModelIndex.new), qVariantFromValue( Qt::AlignRight ), Qt::TextAlignmentRole )

      products_model.setData( products_model.index( row, 3, Qt::ModelIndex.new), Qt::Variant.new( "#{product.price_pvp} EUR") )
      products_model.setData( products_model.index( row, 3, Qt::ModelIndex.new), qVariantFromValue( Qt::AlignRight ), Qt::TextAlignmentRole )

      products_model.setData( products_model.index( row, 4, Qt::ModelIndex.new), Qt::Variant.new( "#{product.price_type} EUR" ) )
      products_model.setData( products_model.index( row, 4, Qt::ModelIndex.new), qVariantFromValue( Qt::AlignRight ), Qt::TextAlignmentRole )

      products_model.setData( products_model.index( row, 5, Qt::ModelIndex.new), Qt::Variant.new( "#{product.iva} %" ) )
      products_model.setData( products_model.index( row, 5, Qt::ModelIndex.new), qVariantFromValue( Qt::AlignRight ), Qt::TextAlignmentRole )

      products_model.setData( products_model.index( row, 6, Qt::ModelIndex.new), Qt::Variant.new( "#{product.weight_per_unit} Kg/Un" ) )
      products_model.setData( products_model.index( row, 6, Qt::ModelIndex.new), qVariantFromValue( Qt::AlignRight ), Qt::TextAlignmentRole )
    end
